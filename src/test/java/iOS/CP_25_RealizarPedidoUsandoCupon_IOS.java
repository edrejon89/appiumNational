...
public class CP_25_RealizarPedidoUsandoCupon_IOS extends BaseTestIOS_Mac {
    ...
    public void CP_25_RealizarPedidoUsandoCupon_IOSTest() {
        try {
            ...
            new TouchAction(driver).press(20,250).perform();
...
//            Assert.fail(tpay);
            if (tpay.equals(" ¡YA CUENTAS CON ESTA PROMOCIÓN!")){
                ...
                if (yacuenta.isDisplayed()){
                    wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@text='Aceptar']")));
                }
                wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='UIAButton' and ./parent::*[@text='prueba de promocion']]"))).click();
            }
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@text='Pasar a BURRITO10.jpgrecoger']"))).click();
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//*[@class='UIAView' and ./parent::*[@class='UIAView' and ./parent::*[@class='UIAView' and ./parent::*[@class='UIAView' and ./parent::*[@class='UIAView' and ./parent::*[@class='UIAView']]]]]]/*[@text='$120.00'])[2]"))).click();
