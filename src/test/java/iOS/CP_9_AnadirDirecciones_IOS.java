...
public class CP_9_AnadirDirecciones_IOS extends BaseTestIOS_Mac{
    @Test
    public void CP_9_AnadirDirecciones_IOS(){
        try {
            Thread.sleep(15000);
            ...
            String fallo = driver.findElement(By.xpath("//*[@text='Ingresar']")).getText();

            if (fallo.equals("Ingresar")) {
                ...
                wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@text='more, numbers']"))).click();
                wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@placeholder='C.P.']"))).sendKeys(parametros[5]);
                ...
                wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@text='more, numbers']"))).click();
                wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@placeholder='Referencias']"))).sendKeys(parametros[6]);
